...
class EventListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = (
            "id", "title", "slug", "banner_image", 
            "venue_name", "start_date", "status", "owner_name",
        )
...
class EventDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = (
            "id", "title", "slug", "description", "venue_name", 
            "venue_address", "start_date", "end_date", 
            "registration_deadline", "banner_image", "status", 
            "is_public", "is_live", "can_register", "owner", 
